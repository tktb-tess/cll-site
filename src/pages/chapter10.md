...
In [Example 10.113](/chapter10/#example-random-id-MzxF "Example 10.113. "), the origin point is the speaker, as is usual with *zu'aku*. [Example 10.110](/chapter10/#example-random-id-9Q0x "Example 10.110. ") makes the origin point of the tense the event described by the first sentence.
...
In both [Example 10.115](/chapter10/#example-random-id-o3Yg "Example 10.115. ") and [Example 10.116](/chapter10/#example-random-id-vSCv "Example 10.116. "), the underlying sentences *mi klama le zarci* and *mi klama le zdani* are not claimed; only the relationship in time between them is claimed.
...
As a contradictory negation, [Example 10.129](/chapter10/#example-random-id-qXWF "Example 10.129. ") implies that the bridi as a whole is false without saying anything about what is true. When the negated tense is a sumti tcita, *-nai* negation indicates that the stated relationship does not hold:
...
The use of *-nai* on cmavo of TAhE and ROI has already been discussed in [Section 10.9](/chapter10/#section-interval-properties "10.9. Interval properties: TAhE and roi"); this use is also a scalar negation.
